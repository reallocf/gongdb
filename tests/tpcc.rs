...
fn test_tpcc_benchmark() {
    ...
    format_result("TPC-C Setup", gongdb_time, rusqlite_time);
    ...
    format_result("New Order Transaction", gongdb_time, rusqlite_time);
    ...
    format_result("Payment Transaction", gongdb_time, rusqlite_time);
    ...
    format_result("Order Status Transaction", gongdb_time, rusqlite_time);
    ...
    format_result("Stock Level Transaction", gongdb_time, rusqlite_time);
    ...
    format_result("Delivery Transaction", gongdb_time, rusqlite_time);
